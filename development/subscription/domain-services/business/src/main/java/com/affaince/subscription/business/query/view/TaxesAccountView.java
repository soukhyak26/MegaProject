 ...
 */
@Document(collection = "TaxesAccount")
public class TaxesAccountView {
    ...
    public TaxesAccountView(String year, double startAmount, double currentAmount, LocalDateTime startDate, LocalDateTime endDate) {
        this.year = year;
