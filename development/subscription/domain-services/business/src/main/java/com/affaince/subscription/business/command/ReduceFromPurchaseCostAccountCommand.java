 ...
 */
public class ReduceFromPurchaseCostAccountCommand {
    ...
    public ReduceFromPurchaseCostAccountCommand(Integer id, String productId, long getTotalProductSubscriptionCount, double currentProductPurchasePrice, LocalDate provisionsDate ) {
        Id = id;
