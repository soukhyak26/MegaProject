...
import com.affaince.subscription.business.command.event.ProductDemandIncreaseNotificationEvent;
 ...
 */
@Component
public class ProductDemandIncreaseNotificationEventListener {

    private static final Logger LOGGER = LoggerFactory.getLogger(ProductDemandIncreaseNotificationEventListener.class);
    private final ProductForecastViewRepository productForecastViewRepository;
    private final ProductViewRepository productViewRepository;
    private final SubscriptionCommandGateway commandGateway;

    @Autowired
    public ProductDemandIncreaseNotificationEventListener(ProductForecastViewRepository productForecastViewRepository, ProductViewRepository productViewRepository, SubscriptionCommandGateway commandGateway) {
    ...
    public void on(ProductDemandIncreaseNotificationEvent event) throws Exception {
        ...
        AddToPurchaseCostAccountCommand command = new AddToPurchaseCostAccountCommand(SysDate.now().getYear(), event.getProductId(), revisedTotalSubscriptionCount, productPurchasePrice, SysDate.now());
