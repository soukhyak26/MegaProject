 ...
 */
@Document(collection = "LossesAccount")
public class LossesAccountView {
    ...
    public LossesAccountView(String year, double startAmount, double currentAmount, LocalDateTime startDate, LocalDateTime endDate) {
        this.year = year;
