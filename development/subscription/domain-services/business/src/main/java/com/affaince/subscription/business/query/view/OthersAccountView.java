 ...
 */
@Document(collection = "OthersAccount")
public class OthersAccountView {
    ...
    public OthersAccountView(String year, double startAmount, double currentAmount, LocalDateTime startDate, LocalDateTime endDate) {
        this.year = year;
