 ...
 */
@Document(collection = "NodalAccount")
public class NodalAccountView {
    ...
    public NodalAccountView(String year, double startAmount, double currentAmount, LocalDateTime startDate, LocalDateTime endDate) {
        this.year = year;
