 ...
 */
@Document(collection = "NodalAccountView")
public class NodalAccountView {
    @Id
    ...
    public NodalAccountView(Integer year, double startAmount, double currentAmount, LocalDateTime startDate, LocalDateTime endDate) {
        this.year = year;
