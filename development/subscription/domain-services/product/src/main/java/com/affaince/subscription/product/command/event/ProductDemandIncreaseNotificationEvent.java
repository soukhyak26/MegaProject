...
public class ProductDemandIncreaseNotificationEvent {
    ...
    public ProductDemandIncreaseNotificationEvent(String productId, double expectedChangeInNewSubscriptionCount, double expectedChangeInChurnedSubscriptionCount, LocalDate fromDate, LocalDate endDate, LocalDate forecastDate) {
