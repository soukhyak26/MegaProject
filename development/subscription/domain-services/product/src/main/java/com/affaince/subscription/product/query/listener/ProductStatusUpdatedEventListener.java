...
public class ProductStatusUpdatedEventListener {
    ...
    @Autowired
    public ProductStatusUpdatedEventListener(ProductViewRepository productViewRepository ,TaggedPriceVersionsViewRepository taggedPriceVersionsViewRepository, ProductActualsViewRepository productActualsViewRepository) {
