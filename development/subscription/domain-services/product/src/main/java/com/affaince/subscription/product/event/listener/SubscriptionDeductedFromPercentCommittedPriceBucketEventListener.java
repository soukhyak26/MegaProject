...
import com.affaince.subscription.product.event.SubscriptionDeductedFromPercentCommittedPriceBucketEvent;
...
public class SubscriptionDeductedFromPercentCommittedPriceBucketEventListener {
    ...
    @Autowired
    public SubscriptionDeductedFromPercentCommittedPriceBucketEventListener(ProductActualsViewRepository productActualsViewRepository, PriceBucketViewRepository priceBucketViewRepository,PriceBucketTransactionViewRepository priceBucketTransactionViewRepository, SubscriptionCommandGateway commandGateway) {
...
//        ProductActualsView productActualsView = productActualsViewRepository.findByProductVersionId_ProductId(event.getProductId(), sort).get(0);
        ...
        PriceBucketTransactionView priceBucketTransactionView = priceBucketTransactionViewRepository.findOne(new PriceBucketTransactionId(event.getProductId(),event.getPriceBucketId(),event.getSubscriptionChangeDate()));
