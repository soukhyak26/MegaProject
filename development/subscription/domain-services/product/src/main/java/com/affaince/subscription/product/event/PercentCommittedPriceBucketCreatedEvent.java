 ...
 */
public class PercentCommittedPriceBucketCreatedEvent {
    ...
    public PercentCommittedPriceBucketCreatedEvent(String productId, String priceBucketId, ProductPricingCategory productPricingCategory, PriceTaggedWithProduct taggedPriceVersion, double offeredPriceOrPercentDiscountPerUnit, EntityStatus entityStatus, LocalDateTime fromDate) {
