...
public class UpdateDeliveryStatusCommand {
    ...
    public UpdateDeliveryStatusCommand(String subscriptionId, String deliveryId, LocalDate deliveryDate, DeliveryStatus deliveryStatus, List<ItemDispatchStatus> itemWiseDispatchStatus, double deliveryCharges) {
