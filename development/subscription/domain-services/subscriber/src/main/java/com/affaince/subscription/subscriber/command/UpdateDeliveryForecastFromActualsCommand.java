 ...
 */
public class UpdateDeliveryForecastFromActualsCommand {
    private Integer subscriptionAnalyserId;
    private EntityMetricType entityMetricType;
    private LocalDate forecastDate;

    public UpdateDeliveryForecastFromActualsCommand(Integer subscriptionAnalyserId, EntityMetricType entityMetricType, LocalDate forecastDate) {
