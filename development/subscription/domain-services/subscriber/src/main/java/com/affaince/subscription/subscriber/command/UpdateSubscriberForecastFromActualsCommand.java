 ...
 */
public class UpdateSubscriberForecastFromActualsCommand {
    private Integer subscriptionAnalyserId;
    private EntityMetricType entityMetricType;
    private LocalDate forecastDate;

    public UpdateSubscriberForecastFromActualsCommand(Integer subscriptionAnalyserId, EntityMetricType entityMetricType, LocalDate forecastDate) {
