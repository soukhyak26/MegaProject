 ...
 */
public class LatestPriceBucketUpdatedEvent {
    private String productId;
    private String priceBucketId;
    private double offeredPricePerUnit;
    private LocalDateTime currentPriceDate;

    public LatestPriceBucketUpdatedEvent() {
    }

    public LatestPriceBucketUpdatedEvent(String productId, String priceBucketId, double offeredPricePerUnit, LocalDateTime currentPriceDate) {
