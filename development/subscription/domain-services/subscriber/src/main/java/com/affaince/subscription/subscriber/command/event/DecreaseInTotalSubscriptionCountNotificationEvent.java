 ...
 */
public class DecreaseInTotalSubscriptionCountNotificationEvent {
    private double expectedChangeInTotalSubscriptionCount;
    private  LocalDate startDate;
    private  LocalDate endDate;
    private LocalDate forecastDate;

    public DecreaseInTotalSubscriptionCountNotificationEvent(double expectedChangeInTotalSubscriptionCount, LocalDate startDate, LocalDate endDate, LocalDate forecastDate) {
