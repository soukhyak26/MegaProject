...
@WebAppConfiguration
@Ignore
public class ExtraPolationBasedOperatingExpenseDistributionDeterminatorTest {

    @Autowired
    private ExtraPolationBasedOperatingExpenseDistributionDeterminator extraPolationBasedOperatingExpenseDistributionDeterminator;

    @Test
    public void testDistributeDeliveryExpensesToProductTest () throws IOException {
        Map<String, Double> perUnitOperationExpense =
                extraPolationBasedOperatingExpenseDistributionDeterminator.distributeDeliveryExpensesToProduct();
