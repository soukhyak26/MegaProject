 ...
 */
@Component
public class ARIMABasedDemandForecaster2 {
    ...
    public ARIMABasedDemandForecaster2() {
    }
    ...
    public List<Double> forecast(String dataIdentifier, List<DataFrameVO> dataFrames) {
