...
When method get
Then status 200
And match response == read('classpath:domains/subscriber/modifysubscription/read-subscription2.json')
...
When method get
Then status 200
And match response == read('classpath:domains/subscriber/modifysubscription/read-payment-account2.json')
...
When method get
Then status 200
And match response == read('classpath:domains/subscriber/modifysubscription/read-paymentinstallments2.json')
