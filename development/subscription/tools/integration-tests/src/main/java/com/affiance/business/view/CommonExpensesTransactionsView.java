...
public class CommonExpensesTransactionsView extends AccountTransactionsView {
    public CommonExpensesTransactionsView(LocalDate dateOfTransaction, double transactedAmount, TransactionType transactionType, TransactionReasonCode transactionReasonCode) {
