...
public class DeliverableProductDetail {
    ...
    public DeliverableProductDetail(){}
    public DeliverableProductDetail(String deliveryItemId){
        this.deliveryItemId = deliveryItemId;
    }
    public DeliverableProductDetail(String deliveryItemId, String priceBucketId) {
        this.deliveryItemId = deliveryItemId;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeliverableProductDetail)) return false;

        DeliverableProductDetail that = (DeliverableProductDetail) o;
