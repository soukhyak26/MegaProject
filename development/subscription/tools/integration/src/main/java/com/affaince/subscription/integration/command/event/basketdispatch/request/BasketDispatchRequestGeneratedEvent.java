...
public class BasketDispatchRequestGeneratedEvent {
    ...
    @DataField(columnName = "PRODUCT_ID", name = "PRODUCT_ID", pos = 2, trim = true)
    ...
    @DataField(columnName = "DELIVERY_DATE", name = "DELIVERY_DATE", pos = 6, pattern = "yyyyddMM", trim = true)
    private Date deliveryDate;

    public BasketDispatchRequestGeneratedEvent() {
    }

    public BasketDispatchRequestGeneratedEvent(String subscriberId, String categoryId, String subCategoryId, String productId, double quotedPrice, Date deliveryDate) {
