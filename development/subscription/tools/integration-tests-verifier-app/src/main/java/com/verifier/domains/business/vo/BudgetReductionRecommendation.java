...
public class BudgetReductionRecommendation implements BudgetChangeRecommendation{
    ...
    public BudgetReductionRecommendation(String recommenderId, LocalDate recommendationDate, RecommenderType recommenderType, double recommendationAmount, LocalDate periodStartDate, LocalDate periodEndDate, RecommendationReason recommendationReason,RecommendationReceiver recommendationReceiver) {
