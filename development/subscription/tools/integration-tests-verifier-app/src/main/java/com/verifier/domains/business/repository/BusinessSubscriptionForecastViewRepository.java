...
public interface BusinessSubscriptionForecastViewRepository extends CrudRepository<SubscriptionForecastView, SubscriptionVersionId> {
    ...
    public List<SubscriptionForecastView> findBySubscriptionVersionId_ValueRangeMinAndSubscriptionVersionId_ValueRangeMaxAndForecastContentStatus(double valueRangeMin, double valueRangeMax,ForecastContentStatus forecastContentStatus);
