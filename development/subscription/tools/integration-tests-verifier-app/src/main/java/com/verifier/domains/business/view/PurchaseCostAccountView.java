...
public class PurchaseCostAccountView extends ProvisionAccountView{

    public PurchaseCostAccountView(){super();}
    public PurchaseCostAccountView(String businessAccountId, double provisionAmount, LocalDate startDate, LocalDate endDate) {
