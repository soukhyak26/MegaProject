...
public class OthersAccountTransactionsView extends AccountTransactionsView {
    public OthersAccountTransactionsView(){
        super();
    }
    public OthersAccountTransactionsView(LocalDate dateOfTransaction, String contributorId, double transactedAmount, TransactionType transactionType, TransactionReasonCode transactionReasonCode) {
