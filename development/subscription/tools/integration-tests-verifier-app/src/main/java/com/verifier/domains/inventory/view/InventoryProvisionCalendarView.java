...
import com.verifier.domains.inventory.vo.InventoryProvisionCalendarVersionId;
...
public class InventoryProvisionCalendarView {
    ...
    /*   public void addProvisionSegment(InventoryProvisionSegment matchingProvisionSegment){
