 ...
 */
public interface BusinessCommonOperatingExpenseConfigViewRepository extends CrudRepository<CommonOperatingExpenseConfigView,CommonOperatingExpenseHeader> {
}
