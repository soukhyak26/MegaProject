...
public class PrceTest {
    ...
    public  static double avg(double demand){return Math.round(demand + demand*0.1);}
    public static void calculatePriceSet1(){
        ...
        while(iterator.hasNext() ){
            ...
            System.out.println("slope: " + tempInput.getSlope() + "| offeredPrice: " + tempInput.getOfferedPrice() + "| qunatity: " + tempInput.getQuantityActual() + "| cost: " + tempInput.getCost() + "| Revenue: " + tempInput.getRevenue() + "| Profit: " + tempInput.getProfit());
        }
        System.out.println("----------------------------------------------------------");
