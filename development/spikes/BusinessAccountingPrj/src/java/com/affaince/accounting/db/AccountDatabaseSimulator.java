...
public class AccountDatabaseSimulator {
    ...
    public static void buildDatabase(){
        ...
        //business
        LedgerAccount capitalLedgerAccount = new PersonalAccount("merchant1","merchant1", AccountIdentifier.BUSINESS_CAPITAL_ACCOUNT);
        allAccounts.add(capitalLedgerAccount);
        LedgerAccount bankLedgerAccount = new PersonalAccount("merchant1","merchant1",AccountIdentifier.BUSINESS_BANK_ACCOUNT);
        allAccounts.add(bankLedgerAccount);

        LedgerAccount cashLedgerAccount = new RealAccount("merchant1","merchant1",AccountIdentifier.BUSINESS_CASH_ACCOUNT);
        ...
        LedgerAccount discountLedgerAccount = new NominalAccount("merchant1","merchant1",AccountIdentifier.BUSINESS_DISCOUNT_ACCOUNT);
        allAccounts.add(discountLedgerAccount);
        LedgerAccount lossAccount = new NominalAccount("merchant1","merchant1",AccountIdentifier.BUSINESS_LOSS_ACCOUNT);
        allAccounts.add(lossAccount);
        LedgerAccount profitAccount = new NominalAccount("merchant1","merchant1",AccountIdentifier.BUSINESS_PROFIT_ACCOUNT);
        allAccounts.add(profitAccount);
        LedgerAccount rentLedgerAccount = new NominalAccount("merchant1","merchant1",AccountIdentifier.OWNER_OF_PREMISE_RENTED_ACCOUNT);
        allAccounts.add(rentLedgerAccount);
        LedgerAccount rewardLedgerAccount = new NominalAccount("merchant1","merchant1",AccountIdentifier.SUBSCRIBER_REWARDS_ACCOUNT);
        allAccounts.add(rewardLedgerAccount);
        LedgerAccount salaryLedgerAccount = new NominalAccount("merchant1","merchant1",AccountIdentifier.EMPLOYEE_SALARY_ACCOUNT);
        allAccounts.add(salaryLedgerAccount);
        LedgerAccount salesAccount = new NominalAccount("merchant1","merchant1",AccountIdentifier.BUSINESS_SALES_ACCOUNT);
        allAccounts.add(salesAccount);
        LedgerAccount businessServicesAvailedAccount = new NominalAccount("merchant1","merchant1",AccountIdentifier.BUSINESS_SERVICES_AVAILED_ACCOUNT);
        allAccounts.add(businessServicesAvailedAccount);
        LedgerAccount goodReturnedAccount = new NominalAccount("merchant1","merchant1",AccountIdentifier.BUSINESS_SALES_RETURN_ACCOUNT);
