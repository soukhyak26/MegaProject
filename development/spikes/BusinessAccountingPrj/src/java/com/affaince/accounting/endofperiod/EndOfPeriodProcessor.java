...
public class EndOfPeriodProcessor {

    public void processEndOfPeriodOperations(String merchant, LocalDateTime closureDate, TradingFrequency tradingFrequency) {
    ...
    private double calculateClosingBalanceAmount(String merchant){
    ...
    private ClosingStockAccount createClosingStockAccount(String merchantId, LocalDateTime closureDate, TradingFrequency tradingFrequency) {
        ...
        double closingBalanceAmount = calculateClosingBalanceAmount(merchantId);
    ...
    private OpeningStockAccount createOpeningStockAccount(String merchantId, LocalDateTime
            closureDate, TradingFrequency tradingFrequency) {
