...
public class ProfitAndLossAccountEntry {
    private LocalDateTime date;
    private String peerAccountNumber;
    private AccountIdentifier accountIdentifier;
    private double amount;

    public ProfitAndLossAccountEntry(LocalDateTime date, String peerAccountNumber, AccountIdentifier accountIdentifier, double amount) {
        this.date = date;
